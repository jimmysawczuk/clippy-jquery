...
*/
(function(a){a.fn.clippy=function(d){_opts={width:14,height:14,color:"#ffffff",clippy_path:"clippy.swf",keep_text:false,transparent:false,force_load:false,flashvars:{}};d=a.extend(_opts,d);var b=false;try{var c=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(c){b=true}}catch(f){if(navigator.mimeTypes["application/x-shockwave-flash"]!=undefined){b=true}}if(b||d.force_load){this.each(function(e,h){if(d.text&&d.text!=""){text=d.text}else{if(a(h).data("text")&&a(h).data("text")!=""){text=a(h).data("text")}else{text=a(h).text()}}text=encodeURIComponent(text);var i="";if(typeof a(this).attr("id")==="undefined"||a.trim(a(this).attr("id")==="")){var g=Math.round(Math.random()*1024).toString(16);i="clippy-"+g;a(this).attr("id",i)}else{i=a(this).attr("id")}if(d.keep_text){a(this).html("")}swfobject.embedSWF(d.clippy_path,i,d.width,d.height,"10",false,a.extend(d.flashvars,{text:text}),{scale:"noscale"})})}else{this.each(function(e,g){a(this).css({display:"none"})})}}})(jQuery);